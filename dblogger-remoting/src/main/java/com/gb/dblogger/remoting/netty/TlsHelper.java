...
package com.gb.dblogger.remoting.netty;
...
import static com.gb.dblogger.remoting.netty.TlsSystemConfig.TLS_TEST_MODE_ENABLE;
...
public class TlsHelper {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RemotingHelper.DBLOGGER_REMOTING);
