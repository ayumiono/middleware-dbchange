 ...
 */
package com.gb.dblogger.remoting.common;
...
public class RemotingHelper {
    public static final String DBLOGGER_REMOTING = "DbLoggerRemoting";
    public static final String DEFAULT_CHARSET = "UTF-8";

    private static final Logger log = LoggerFactory.getLogger(DBLOGGER_REMOTING);
